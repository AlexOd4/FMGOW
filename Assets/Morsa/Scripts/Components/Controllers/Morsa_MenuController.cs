...
public class Morsa_MenuController : MonoBehaviour
{
    ...
    public void Game()
    {
        ...
        Morsa_RoundManager.instance.Begin();
    }
    ...
    public void End()
    {
        ...
        Morsa_RoundManager.instance.AbortRound();
    ...
    {
        Morsa_RoundManager.instance.BlockHand();
    ...
    {
        Morsa_RoundManager.instance.ReleaseHand();
