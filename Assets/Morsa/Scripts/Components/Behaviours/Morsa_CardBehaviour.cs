...
public class Morsa_CardBehaviour : MonoBehaviour
{
    [SerializeField] public Morsa_Card card;
    ...
    public Morsa_SlotBehaviour linkedSlot;
    ...
    public void Link(Morsa_SlotBehaviour slot)
    {
    ...
    public void Select()
    {
        Morsa_RoundManager.instance.Deselect();
